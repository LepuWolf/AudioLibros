...
public class Libro {
    ...
    static{
        ...
        libros.add(new Libro("Kappa", "Akutagawa", R.drawable.kappa, SERVIDOR + "el_arte_de_la_guerra.mp3", Libro.G_S_XIX, false, false));
        ...
        libros.add(new Libro("Canción de Rolando", "Anónimo", R.drawable.cancion_rolando, SERVIDOR + "una_cancion_para_susana.mp3", Libro.G_EPICO, false, true));
        libros.add(new Libro("Matrimonio de sabuesos", "Agata Christie", R.drawable.matrim_sabuesos, SERVIDOR + "Cuentos_de_Lovecraft.mp3", Libro.G_SUSPENSE, false, true));
